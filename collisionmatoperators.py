...
class CreateVCollisionMaterial(bpy.types.Operator):
    """Creates a vshader"""
    bl_idname = "sollum.createvcollisionmaterial"
    bl_label = "Create Collision Material"
    collisionindex : bpy.props.StringProperty(default = "0")

    def execute(self, context):
        create_with_index(self.collisionindex, context)
        return {'FINISHED'}
    
def register():
    bpy.utils.register_class(CreateVCollisionMaterial)
def unregister():
    bpy.utils.unregister_class(CreateVCollisionMaterial)
