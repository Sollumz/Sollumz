...
collisionmats = [
    ...
    CollisionMaterial('CONCRETE_POTHOLE', 'Concrete Pothole', (145, 145, 145, 255)),
    CollisionMaterial('CONCRETE_DUSTY', 'Concrete Dusty', (145, 140, 130, 255)),
    ...
    CollisionMaterial('SANDSTONE_SOLID', 'Sandstone Solid', (215, 195, 150, 255)),
    CollisionMaterial('SANDSTONE_BRITTLE', 'Sandstone Brittle', (205, 180, 120, 255)),
    ...
    CollisionMaterial('SAND_UNDERWATER', 'Sand Underwater', (135, 130, 120, 255)),
    ...
    CollisionMaterial('GRAVEL_TRAIN_TRACK', 'Gravel Train Track', (145, 140, 130, 255)),
    ...
    CollisionMaterial('METAL_SOLID_SMALL', 'Metal Solid Small', (155, 180, 190, 255)),
    CollisionMaterial('METAL_SOLID_MEDIUM', 'Metal Solid Medium', (155, 180, 190, 255)),
    CollisionMaterial('METAL_SOLID_LARGE', 'Metal Solid Large', (155, 180, 190, 255)),
    CollisionMaterial('METAL_HOLLOW_SMALL', 'Metal Hollow Small', (155, 180, 190, 255)),
    CollisionMaterial('METAL_HOLLOW_MEDIUM', 'Metal Hollow Medium', (155, 180, 190, 255)),
    CollisionMaterial('METAL_HOLLOW_LARGE', 'Metal Hollow Large', (155, 180, 190, 255)),
    CollisionMaterial('METAL_CHAINLINK_SMALL', 'Metal Chainlink Small', (155, 180, 190, 255)),
    CollisionMaterial('METAL_CHAINLINK_LARGE', 'Metal Chainlink Large', (155, 180, 190, 255)),
    CollisionMaterial('METAL_CORRUGATED_IRON', 'Metal Corrugated Iron', (155, 180, 190, 255)),
    ...
    CollisionMaterial('METAL_GARAGE_DOOR', 'Metal Garage Door', (155, 180, 190, 255)),
    CollisionMaterial('METAL_MANHOLE', 'Metal Manhole', (155, 180, 190, 255)),
    CollisionMaterial('WOOD_SOLID_SMALL', 'Wood Solid Small', (155, 130, 95, 255)),
    CollisionMaterial('WOOD_SOLID_MEDIUM', 'Wood Solid Medium', (155, 130, 95, 255)),
    CollisionMaterial('WOOD_SOLID_LARGE', 'Wood Solid Large', (155, 130, 95, 255)),
    CollisionMaterial('WOOD_SOLID_POLISHED', 'Wood Solid Polished', (155, 130, 95, 255)),
    CollisionMaterial('WOOD_FLOOR_DUSTY', 'Wood Floor Dusty', (165, 145, 110, 255)),
    CollisionMaterial('WOOD_HOLLOW_SMALL', 'Wood Hollow Small', (170, 150, 125, 255)),
    CollisionMaterial('WOOD_HOLLOW_MEDIUM', 'Wood Hollow Medium', (170, 150, 125, 255)),
    CollisionMaterial('WOOD_HOLLOW_LARGE', 'Wood Hollow Large', (170, 150, 125, 255)),
    CollisionMaterial('WOOD_CHIPBOARD', 'Wood Chipboard', (170, 150, 125, 255)),
    CollisionMaterial('WOOD_OLD_CREAKY', 'Wood Old Creaky', (155, 130, 95, 255)),
    CollisionMaterial('WOOD_HIGH_DENSITY', 'Wood High Density', (155, 130, 95, 255)),
    ...
    CollisionMaterial('PLASTIC_HOLLOW', 'Plastic Hollow', (240, 230, 185, 255)),
    CollisionMaterial('PLASTIC_HIGH_DENSITY', 'Plastic High Density', (255, 250, 210, 255)),
    CollisionMaterial('PLASTIC_CLEAR', 'Plastic Clear', (255, 250, 210, 255)),
    CollisionMaterial('PLASTIC_HOLLOW_CLEAR', 'Plastic Hollow Clear', (240, 230, 185, 255)),
    CollisionMaterial('PLASTIC_HIGH_DENSITY_CLEAR', 'Plastic High Density Clear', (255, 250, 210, 255)),
    CollisionMaterial('FIBREGLASS_HOLLOW', 'Fibreglass Hollow', (240, 230, 185, 255)),
    ...
    CollisionMaterial('CARPET_SOLID_DUSTY', 'Carpet Solid Dusty', (255, 135, 135, 255)),
    CollisionMaterial('CARPET_FLOORBOARD', 'Carpet Floorboard', (250, 100, 100, 255)),
    CollisionMaterial('CLOTH', 'Cloth', (250, 100, 100, 255)),
    CollisionMaterial('PLASTER_SOLID', 'Plaster Solid', (145, 145, 145, 255)),
    CollisionMaterial('PLASTER_BRITTLE', 'Plaster Brittle', (225, 225, 225, 255)),
    CollisionMaterial('CARDBOARD_SHEET', 'Cardboard Sheet', (120, 115, 95, 255)),
    ...
    CollisionMaterial('FEATHER_PILLOW', 'Feather Pillow', (230, 230, 230, 255)),
    ...
    CollisionMaterial('SLATTED_BLINDS', 'Slatted Blinds', (255, 250, 210, 255)),
    CollisionMaterial('GLASS_SHOOT_THROUGH', 'Glass Shoot Through', (205, 240, 255, 255)),
    CollisionMaterial('GLASS_BULLETPROOF', 'Glass Bulletproof', (115, 125, 125, 255)),
    ...
    CollisionMaterial('CAR_SOFTTOP_CLEAR', 'Car Softtop Clear', (250, 100, 100, 255)),
    CollisionMaterial('CAR_GLASS_WEAK', 'Car Glass Weak', (210, 245, 245, 255)),
    CollisionMaterial('CAR_GLASS_MEDIUM', 'Car Glass Medium', (210, 245, 245, 255)),
    CollisionMaterial('CAR_GLASS_STRONG', 'Car Glass Strong', (210, 245, 245, 255)),
    CollisionMaterial('CAR_GLASS_BULLETPROOF', 'Car Glass Bulletproof', (210, 245, 245, 255)),
    CollisionMaterial('CAR_GLASS_OPAQUE', 'Car Glass Opaque', (210, 245, 245, 255)),
    ...
    CollisionMaterial('EMISSIVE_GLASS', 'Emissive Glass', (205, 240, 255, 255)),
    CollisionMaterial('EMISSIVE_PLASTIC', 'Emissive Plastic', (255, 250, 210, 255)),
    CollisionMaterial('VFX_METAL_ELECTRIFIED', 'Vfx Metal Electrified', (155, 180, 190, 255)),
    CollisionMaterial('VFX_METAL_WATER_TOWER', 'Vfx Metal Water Tower', (155, 180, 190, 255)),
    CollisionMaterial('VFX_METAL_STEAM', 'Vfx Metal Steam', (155, 180, 190, 255)),
    CollisionMaterial('VFX_METAL_FLAME', 'Vfx Metal Flame', (155, 180, 190, 255)),
    ...
    CollisionMaterial('PHYS_CASTER_RUSTY', 'Phys Caster Rusty', (0, 0, 0, 255)),
    CollisionMaterial('PHYS_CAR_VOID', 'Phys Car Void', (0, 0, 0, 255)),
    CollisionMaterial('PHYS_PED_CAPSULE', 'Phys Ped Capsule', (0, 0, 0, 255)),
    CollisionMaterial('PHYS_ELECTRIC_FENCE', 'Phys Electric Fence', (0, 0, 0, 255)),
    CollisionMaterial('PHYS_ELECTRIC_METAL', 'Phys Electric Metal', (0, 0, 0, 255)),
    CollisionMaterial('PHYS_BARBED_WIRE', 'Phys Barbed Wire', (0, 0, 0, 255)),
    CollisionMaterial('PHYS_POOLTABLE_SURFACE', 'Phys Pooltable Surface', (155, 130, 95, 255)),
    CollisionMaterial('PHYS_POOLTABLE_CUSHION', 'Phys Pooltable Cushion', (155, 130, 95, 255)),
    CollisionMaterial('PHYS_POOLTABLE_BALL', 'Phys Pooltable Ball', (255, 250, 210, 255)),
    ...
    CollisionMaterial('CONCRETE_PAVEMENT', 'Concrete Pavement', (145, 145, 145, 255)),
    CollisionMaterial('BRICK_PAVEMENT', 'Brick Pavement', (195, 95, 30, 255)),
    CollisionMaterial('PHYS_DYNAMIC_COVER_BOUND', 'Phys Dynamic Cover Bound', (0, 0, 0, 255)),
    CollisionMaterial('VFX_WOOD_BEER_BARREL', 'Vfx Wood Beer Barrel', (155, 130, 95, 255)),
    CollisionMaterial('WOOD_HIGH_FRICTION', 'Wood High Friction', (155, 130, 95, 255)),
    CollisionMaterial('ROCK_NOINST', 'Rock Noinst', (185, 185, 185, 255)),
    CollisionMaterial('BUSHES_NOINST', 'Bushes Noinst', (85, 160, 30, 255)),
    CollisionMaterial('METAL_SOLID_ROAD_SURFACE', 'Metal Solid Road Surface', (155, 180, 190, 255)),
]
