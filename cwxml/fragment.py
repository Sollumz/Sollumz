...
class PhysicsGroup(ElementTree):
    ...
    def __init__(self):
        ...
        self.total_undamaged_mass = ValueProperty("TotalUndamagedMass")
        self.total_damaged_mass = ValueProperty("TotalUndamagedMass")
...
class PhysicsLOD(ElementTree):
    ...
    def __init__(self, tag_name="LOD"):
        ...
        self.smallest_ang_inertia = ValueProperty("SmallestAngInertia")
        self.largest_ang_inertia = ValueProperty("LargestAngInertia")
        self.min_move_force = ValueProperty("MinMoveForce")
        self.position_offset = VectorProperty("PositionOffset")
        self.original_root_cg_offset = VectorProperty("OriginalRootCGOffset")
        self.unbroken_cg_offset = VectorProperty("UnbrokenCGOffset")
