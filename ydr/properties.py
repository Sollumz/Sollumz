...
def register():
    ...
    bpy.types.Scene.convert_ydr_use_mesh_names = bpy.props.BoolProperty(name='Use Mesh Names', description='Use the names of the meshes for the drawables.', default=True)
