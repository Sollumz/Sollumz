...
from ...utils import get_selected_archetype, get_selected_archetypes_collection
...
ARCHETYPE_PRESET_CATEGORY = PresetCategory(
    ...
    get_targets=make_get_targets_from_collection(get_selected_archetypes_collection),
    poll=_poll,
)
